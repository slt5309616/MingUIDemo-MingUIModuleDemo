Shader "Vacuum/Flow/Unlit/Flow_Texture" {
	Properties {
		...
		_PhaseLength("_PhaseLength", float) = 0
	}
	SubShader {
		...
		Pass {
			CGPROGRAM
				...
				float4 frag(v2f IN) : COLOR 
				{
					...
					half4 retColor; 
					retColor.rgb = mainColor.rgb * _MainColor.rgb * (1-flowMap.r) + final.rgb * flowMap.b * _FlowColor.rgb * _FlowColor.a;
